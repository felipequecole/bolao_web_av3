...
class PalpiteForm extends React.Component {
                ...
                <div className="col-lg-12 text-center">
                    ...
                    <form className="form-horizontal" name="formPalpite">
                        ...
                        <div className="form-group">
                            ...
                            <div className={this.state.mensagensValidacao['email'] === '' ? "col-sm-4" : "col-sm-4 has-error"}>
                                <input type="email"
                            ...
                            <div className={this.state.mensagensValidacao['senha'] === '' ? "col-sm-4" : "col-sm-4 has-error"}>
                                <input type="password"
                                    className="form-control"
                                    name="senha"
                                    label="Senha"
                        ...
                        <div className="form-group">
                            ...
                            <div className={this.state.mensagensValidacao['nome'] === '' ? "col-sm-10" : "col-sm-10 has-error"}>
                                <input type="text"
                                    className="form-control"
                                    name="nome"
                                    label="Nome"
                        ...
                        <div className="form-group">
                            ...
                            <div className={this.state.mensagensValidacao['telefone'] === '' ? "col-sm-4" : "col-sm-4 has-error"}>
                                <input type="text"
                                    className="form-control"
                                    name="telefone"
                                    label="Telefone"
                            ...
                            <div className={this.state.mensagensValidacao['dataDeNascimento'] === '' ? "col-sm-3" : "col-sm-3 has-error"}>
                                <input type="date"
                                    className="form-control"
                        ...
                        <div className={this.state.estado.camposDadosPalpiteDestaque ? 'form-group has-success' : 'form-group'}>
                            ...
                            <div className={this.state.mensagensValidacao['campeao'] === '' ? "col-sm-4" : "col-sm-4 has-error"}>
                                <input type="text"
                                    className="form-control"
                                    name="campeao"
                                    label="Campeão"
                            ...
                            <div className={this.state.mensagensValidacao['confirmarSenha'] === '' ? "col-sm-4" : "col-sm-4 has-error"}>
                                {this.state.estado.campoConfirmacaoSenhaVisivel && (
                                    <input type="password"
                                        className="form-control"
                                        name="confirmarSenha"
                        ...
                        <div className={this.state.estado.camposDadosPalpiteDestaque ? 'form-group has-success' : 'form-group'}>
                            ...
                            <div className={this.state.mensagensValidacao['vice'] === '' ? "col-sm-4" : "col-sm-4 has-error"}>
                                <input type="text"
                                    className="form-control"
                                    name="vice"
                                    label="Vice"
    ...
    async handleEmailChanged() {
        ...
        try {
            const response = await fetch('http://localhost:8080/BolaoDaCopaV2_RS/webresources/usuario?email=' + this.state.email);
    ...
    async handleConfirmarPalpiteClicked() {
        ...
        try {
            ...
            if (this.state.usuarioEncontrado === null) {
                ...
                const response = await fetch('http://localhost:8080/BolaoDaCopaV2_RS/webresources/usuario', {
                    headers: {
            ...
            await fetch('http://localhost:8080/BolaoDaCopaV2_RS/webresources/palpite', {
                headers: {
                    'Content-Type': 'application/json'
                },
                method: 'POST',
